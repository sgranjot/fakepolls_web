...
plt.pie(votos_por_partido, labels=votos_por_partido.index, autopct='%1.1f%%', startangle=140, colors=[colores_partidos[partido] for partido in votos_por_partido.index])
